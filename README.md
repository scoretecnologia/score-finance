...
```bash
curl -fsSL https://usescore-finance.com/install.sh | bash
```

**Windows:** Install [Docker Desktop](https://www.docker.com/products/docker-desktop/), then:

```bash
git clone https://github.com/score-finance-finance/score-finance.git && cd score-finance
...
<p align="center">
  <img src="docs/screenshot.png" width="800" alt="Score Finance dashboard" />
</p>
