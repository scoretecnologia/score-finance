...
async def get_summary(
    ...
    return await dashboard_service.get_summary(session, company.id, month, balance_date)
...
async def get_monthly_trend(
    ...
    return await dashboard_service.get_monthly_trend(session, company.id, months)
...
async def get_balance_history(
    ...
    return await dashboard_service.get_balance_history(session, company.id, month)
...
async def get_projected_transactions(
    ...
    return await dashboard_service.get_projected_transactions(session, company.id, month)
