...
class Settings(BaseSettings):
    # App
    app_name: str = "Score Finance"
    debug: bool = False

    # Database
    database_url: str = "postgresql+asyncpg://postgres:postgres@localhost:5432/score-finance"
    ...
    # Defaults
    default_currency: str = "BRL"  # fallback currency when user preference is unavailable
